...
var grammar = {
    ...
    {"name": "operation", "symbols": ["atomParen", "_", (l.has("operator") ? {type: "operator"} : operator), "_", "operation"]},
    {"name": "operation", "symbols": ["atomParen"]},
    {"name": "atomParen", "symbols": [(l.has("lparen") ? {type: "lparen"} : lparen), "_", "operation", "_", (l.has("rparen") ? {type: "rparen"} : rparen)]},
